...
from inference import quantize_to_float8, QuantConfig, ActivationCasting
...
def generate_video(
    ...
    pipe.scheduler = CogVideoXDPMScheduler.from_config(pipe.scheduler.config, timestep_spacing="trailing")  # 加载调度器
